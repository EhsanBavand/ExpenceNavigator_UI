...
//       const payload = {
//         userId,
//         date: editExpenseForm.date,             // <-- add date here
...
//       // Update local list including date
...
//                   <tbody>
//                     {expenses.length === 0 ? (
//                       <tr><td colSpan={9} className="text-center">No expenses</td></tr>
//                     ) : (
//                       expenses.map(exp => (
//                         <tr key={exp.id}>
...
export default function ExpenseManager() {
  ...
  const saveEditExpense = async (id) => {
    ...
    try {
      const payload = {
        userId,
        date: rowData.date ?? (original.date ? original.date.split("T")[0] : ""),
                        ...
                        <tr key={exp.id}>
                          ...
                          <td>
                            <select
                              ...
                              onChange={e =>
                                setEditExpenseForm({
                                  ...editExpenseForm,
                                  [exp.id]: { ...row, categoryId: e.target.value }
                                })
                              }
                            >
                              <option value="">Category</option>
                          ...
                          <td>
                            <select
                              ...
                              onChange={e =>
                                setEditExpenseForm({
                                  ...editExpenseForm,
                                  [exp.id]: { ...row, subCategoryId: e.target.value }
                                })
                              }
                            >
                              <option value="">SubCategory</option>
                              {subCategories
                                .filter(sc => sc.categoryId === (row.categoryId ?? exp.categoryId))
                                .map(sc => <option key={sc.id} value={sc.id}>{sc.name}</option>)
                              }
                            </select>
                          </td>
                          ...
                          <td>
                            ...
                            >
                              ...
                              {places
                                .filter(p => p.categoryId === (row.categoryId ?? exp.categoryId))
                                .map(p => <option key={p.id} value={p.id}>{p.name}</option>)
                              }
                            </select>
                          </td>
                          ...
                          <td>
                            <input
                              ...
                              onChange={e =>
                                setEditExpenseForm({
                                  ...editExpenseForm,
                                  [exp.id]: { ...row, isFixed: e.target.checked }
                                })
                              }
                            />
                          </td>
