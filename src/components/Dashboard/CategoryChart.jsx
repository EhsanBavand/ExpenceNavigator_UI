...
//   return (
//     <g onClick={() => onClick?.(payload.CategoryId)} style={{ cursor: "pointer" }}>
//       <rect x={x} y={y} width={width} height={height} fill="#BDBDBD" rx={4} />
//       {expenseWidth > 0 && (
//         <rect x={x} y={y} width={expenseWidth} height={height} fill={fillColor} rx={4} />
//       )}
//     </g>
//   );
// };
...
//     MaxValue: Math.max(Number(item.Budget) || 0, Number(item.TotalExpense) || 0),
//   }));

//   const maxValue = chartData.length ? Math.max(...chartData.map((d) => d.MaxValue)) : 0;
...
//         <div style={{ width: "100%", height: 550 }}>
//           {!hasData ? (
//             <div className="skeleton-box skeleton-chart-lg" style={{ height: 550 }} />
//           ) : (
//             <ResponsiveContainer width="100%" height="100%">
//               <BarChart
//                 layout="vertical"
